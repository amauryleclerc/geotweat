<?php
  ...
  // on doit permettre les cross domain requests pour pouvoir lancer le fichier
  // html hors du serveur (au moins sur firefox)
  ...
  define("CONSUMER_ID", "GclpCcKIu8G5tS0Nh8OcA");
  define("CONSUMER_SECRET", "C94wM42NAzM8YzJalsRGvV1sfIKMVO7ZXrmKtHYPt0k");
  define("ACCESS_TOKEN", "2188462572-KjC9STaAcVmMwWYeZSInCxgzkFlwfVBg7CXhl2W");
  define("ACCESS_TOKEN_SECRET", "noyCFjYGjppUNSBKodsLmdU3uehsfEFALbJRFNeKNjDTk");
